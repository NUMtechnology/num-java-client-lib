...
public class ModuleDNSQueriesFactoryTest {
    ...
    public void getInstance1() throws MalformedURLException {
        moduleFactory.getInstance(appContext, null, null);
    }

    @Test(expected = Exception.class)
    public void getInstance2() throws Exception {
        moduleFactory.getInstance(appContext, NonBlankString.of(""), null);
    }
    ...
    public void getInstance4() throws Exception {
        moduleFactory.getInstance(appContext, NonBlankString.of("1"), null);
    }

    @Test(expected = Exception.class)
    public void getInstance5() throws Exception {
        moduleFactory.getInstance(appContext, NonBlankString.of("1"), NonBlankString.of(""));
    }
    ...
    public void getInstance7() throws Exception {
        final ModuleDNSQueries m1 = moduleFactory.getInstance(appContext, NonBlankString.of("1"), NonBlankString.of("numexample.com"));
        final ModuleDNSQueries m2 = moduleFactory.getInstance(appContext, NonBlankString.of("1"), NonBlankString.of("numexample.com"));
        final ModuleDNSQueries m3 = moduleFactory.getInstance(appContext, NonBlankString.of("2"), NonBlankString.of("numexample.com"));
        final ModuleDNSQueries m4 = moduleFactory.getInstance(appContext, NonBlankString.of("1"), NonBlankString.of("example.com"));
