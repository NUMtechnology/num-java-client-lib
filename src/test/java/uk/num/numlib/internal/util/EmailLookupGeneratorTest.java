...
public class EmailLookupGeneratorTest {
    ...
    public void testConstructor1() {
        final EmailLookupGenerator emailLookupGenerator = new EmailLookupGenerator("john.smith@numexample.com");
    ...
    public void testConstructor2() {
        final EmailLookupGenerator emailLookupGenerator = new EmailLookupGenerator("john.smith@numexample.com/foo");
        assertEquals("numexample.com", emailLookupGenerator.domain);
        assertEquals("john.smith", emailLookupGenerator.localPart);
    ...
    public void testConstructor3() {
        final EmailLookupGenerator emailLookupGenerator = new EmailLookupGenerator("john.smith@numexample.com/foo/bar");
        assertEquals("numexample.com", emailLookupGenerator.domain);
        assertEquals("john.smith", emailLookupGenerator.localPart);
