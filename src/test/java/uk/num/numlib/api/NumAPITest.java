...
public class NumAPITest {
  ...
  private void runQuery(final String numId)
      throws InterruptedException, ExecutionException, TimeoutException, NumInvalidDNSHostException, NumInvalidParameterException, MalformedURLException {
    //
